...
< h3 class = "ui header purple"
style = "margin-left: 30px;" > < i class = "plug icon" > < /i>   <div class="content"><span id="complete_table_text">请完善表格信息 </span > < /div></h3 >

<<<<<<< HEAD
< div class = "ui form"
style = "margin-left: 200px; margin-top: 40px;" > < div class = "seven wide required field" > < label > < span id = "table_name_text" > 表格名称: < /span></label > < input type = "text"
id = "table_name_input" > < /div>
...
>>>>>>> customize
                <select class="ui search dropdown" id="all_class">
                    <option value="" id="input_the_cate_text">输入分类</option > < /select></div > < div id = "save_confirm_div_button"
style = "margin-top: 30px;" > < button class = "ui green button"
style = "margin-left: -30px;"
id = "add_new_class_button" > 新增分类 < /button>
                <button class="ui primary button" style="margin-left: 20px;" id="confirm_button">确定 </button > < button class = "ui red button"
style = "margin-left: 20px;"
id = "cancel_button" > 取消 < /button></div > < /div>

    </div > `,
<<<<<<< HEAD
// 空主页

empty_div = ` < div id = "main_header" > < div id = "please_login"
class = "float_right"
...
">
                    <button class="
ui primary button circular " id="
save_to_cloud " style="
margin - bottom: 40px;
margin - top: 8px;
">保存 </button>
                    <button class="
ui button circular " style="
margin - left: 50px;
" id="
discard_button " style="
margin - bottom: 40px;
margin - top: 8px;
">返回 </button>
                </div>
...
ui teal header ">
                    <i class="
warning circle icon "></i>     <div class="
content "><span id = "
plz_log_in_text ">请登录以便在云端同步您的表格数据!</span></div></h3>
            </div>
...
ui purple header ">
                    <i class="
table circle icon " id="
table_circle_icon "></i>
                    <div class="
content "><span id="
current_selected_table_text ">当前选定表格:</span></div></h3>
                <!-- <img alt="
Avatar " height="
50px " width="
50px " id="
avatar " src="
images / default_avatar.png "> --></div>
        </div>
...
scrollbar ">
                    <h3 class="
prompt " style="
color: #2185D0 " id= "no_select_prompt " > < i class = "info big circle icon blue "
id = "no_select_head " > < /i>   <span id="no_table_selected_text ">当前未选中表格</span > < /h3>
                </div > < div id = "table_button "
style = "display: none;
" > < button class = "ui primary button disabled "
id = "save_to_cloud " > 保存 < /button>
                    <button class="ui button " style="margin - left: 50px;
" id="discard_button ">返回 </button > < /div>
            </div > < /div>
`,
...
<!--
注册页面开始 -->
< div id = "signup_div " > < h3 class = "ui blue header "
style = "margin - left: 10 % ;
" > < i class = "add square icon " > < /i>
            <div class="content "><span id="sign_up_text ">用户注册</span > < div class = "sub header " > < span id = "after_sign_up_text " > 注册后，您就可以将表格保存到云端！ < /span></div > < /div>
        </h3 >
...
">
            ...
            <div class="content "><span id="sign_up_text ">用户注册</span>
                <div class="sub header "><span id="after_sign_up_text ">注册后，您就可以将表格保存到云端！</span></div></div>
        </h3>
...
" id="register_form ">
            ...
            <div class="required field ">
                <label><span id="user_name_text ">用户名：</span > < span id = "username_errormsg "
style = 'float:right' > < /span></label > < input type = "text "
name = "username "
placeholder = "请输入用户名"
id = "username_input " > < /div>

            <!-- 密码 必需 -->
            <div class="required field ">
                <label><span id = "password_text ">密码：<\span><span id="password_errormsg " style='float:right'></span > < /label>
                <input type="password " name="password " placeholder="请输入密码" id="password_input "></div >

<!--
电子邮箱必需 -->
< div class = "required field " > < label > < span id = "email_text " > 电子邮箱： < /span><span id="email_errormsg " style='float:right'></span > < /label>
                <input type="text " name="email " placeholder="请输入email " id="email_input "></div >
...
margin - left: 50px;
" > 注册 < /button>
            <button class="ui violet button " type="reset "><span id = "reset_text ">重置</span > < /button></form > < /div>
    <!-- 注册页面 结束 -->
`,
...
<!--
登录页面开始 -->
< div id = "login_div " > < h3 class = "ui brown header "
style = "margin - left: 10 % ;
" > < i class = "home icon " > < /i>
            <div class="content "><span id="user_log_in_text ">用户登录</span > < div class = "sub header " > < span id = "no_account_text " > 还没有账号？请先注册用户 < /span></div > < /div>
        </h3 >
=======
    // 登录页面
    login_div = `
...
">
            ...
            <div class="content "><span id="user_log_in_text ">用户登录</span>
                <div class="sub header "><span id="no_account_text ">还没有账号？请先注册用户</span></div></div>
        </h3>
>>>>>>> customize
...
id = "username_input " > < /div>
            ...
            <div class="required field ">
                <label><span id="password_text ">密码：</span > < span id = "password_errormsg "
style = 'float:right' > < /span></label > < input type = "password "
name = "password "
placeholder = "请输入密码"
id = "password_input " > < /div>

            <button class="ui red button " id="login_submit_button " style="margin - left: 100px;
margin - top: 25px;
"><span id="denglu_text ">登录</span > < /button></form > < /div> 
    <!-- 登录页面 结束 -->
`;
...
">
          <div class="field " >
                <input type="text " name="avatar_url " placeholder="请输入个性化头像的url " id="avatar_url "></div > < /div>
          <h2 id="username_info ">sonack</h2 > < /div>

        <div id="right_info ">
          <form class="ui form " style="margin: auto;
" id="register_form ">  
            <div class="field ">
                <label><span id="email_text ">电子邮箱：</span > < /label>
                <input type="text " name="email " readonly="" placeholder="请输入email " id="email "></div >

< div class = "field " > < label > < span id = "personal_net_text " > 个人网址： < /span></label > < input type = "text "
name = "person_net "
placeholder = "请输入个人网址"
id = "person_net " > < /div>
            ...
            <div class="field ">
                ...
                <textarea rows="4 " name="intro " placeholder="快介绍一下自己吧~" id="intro "></textarea > < /div>

             <button class="ui red button " id="info_confirm_button " style="margin - right: 50px;
margin - left: 50px;
">确定</button > < button class = "ui violet button "
id = "info_cancel_button " > 取消 < /button></form > < /div>
    </div >
...
var cloud_square_div = ` < div id = "share_square " > < div > < h3 class = "ui header blue "
id = "share_square_header " > < i class = "users icon "
id = "shared_tables_text_icon " > < /i>
            <div class="content "><span id="shared_tables_text ">动态广场</span > < /div></h3 > < /div>
=======
...
<div id="share_square ">
        <div>
          <h3 class="ui header blue " id="share_square_header ">
            ...
            <div class="content "><span id="shared_tables_text ">动态广场</span> </div></h3>  
        </div>
>>>>>>> customize

        <div id="share_square_content_div ">
            <div class="ui feed share_feed_div " id="scrollbar "></div > < /div>
</div > `;



var share_event = ` < div class = "event " > < div > < img src = "images / default_avatar.png "
id = 'ava' > < /div>
    <div class="content ">
        <div class="summary " id="share_sum ">
            <span id="user "></span > < span class = "has_shared_table " > 分享了表格 < /span> <img src="images /
left_yinhao.png " id="
l_y "> <a id="
table "></a> <img src="
images / right_yinhao.png " id="
r_y "><span class="
and_said ">并表示</span> <img src="
images / left_yinhao.png " id="
l_y "> <span id="
comm "></span> <img src="
images / right_yinhao.png " id="
r_y "> <div class="
...
ui buttons ">
          <button class="
ui primary button " id="
cloud_save ">保存 </button>
          <div class="
or " data-text="或"></div>
          <button class="
ui positive button " id="
cloud_save_as ">另存为 </button></div>
...
">
          <button class="
ui teal button " id="
cloud_reset ">恢复 </button>
          <div class="
or " data-text="或"></div>
          <button class="
ui red button " id="
cloud_delete ">删除 </button></div>


          <button class="
ui circular purple button icon cloud_share_button " tabindex="
0 " style="
margin - left: 60px;
id = "" > < div class = "visible content " > < i class = "share alternate icon" > < /i>&nbsp;<span id="share_text">分享... </span > & nbsp; < /div></button >
                        ...
                        $.ajax({
                            ...
                            function(result) {
                                ...
                                if (res.status === 'success') {
                                    ...
                                    $("#username_errormsg").text("用户名合法") state1 = true;
                                } else {
                                    // 用户名已存在
                                    $("#username_errormsg").css("color", "red");
                                    $("#username_errormsg").text("用户名已注册!") state1 = false;
                                }
=======
            var validate_username = function () {
                var username_input = $("#username_input");
            ...
            var validate_username = function() {
                    ...
                    if (username_input.val().length === 0) {
                        ...
                        $.ajax({
                            ...
                            url: remoteHost + "/is_name_valid",
                            success: function(result) {
                                var res = JSON.parse(result) if (res.status === 'success') {
                                    $("#username_errormsg").css("color", "green");
                                    $("#username_errormsg").text("用户不存在!") state1 = false;
                                } else {
                                    $("#username_errormsg").text("") state1 = true;
                                }
=======
            var validate_username = function () {
                var username_input = $("#username_input");
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                                ...
                                if (res.status === 'success') {
                                    ...
                                    // 长用户名处理，显示前6位加...
                                    if (res.log_username.length > 9) res.log_username = res.log_username.substr(0, 6) + "...";
                                    // 显示用户名
...
<<<<<<< HEAD
                            $.each(res, function(idx, ele) {
                                ...
                                opt.append("<img class='remove_button' src='images/remove.png'  height='20px' style='float:right; margin-right:10px;'/>") prt.append(opt);
...
>>>>>>> customize
                            ...
                            $("#left_sidebar a .remove_button").click(function (e) {
                                ...
                                if (con) {
                                    $.ajax({
                                        ...
                                        url: remoteHost + "/delete_class_name",
                            ...
                            // 添加超链接事件
                                ...
                                $.ajax({
                                    type: "get",
                                    url: remoteHost + "/get_all_table?class_name=" + class_name,
                                    success: function (result) {
...
>>>>>>> customize
                                        ...
                                        $("#right_sidebar a").click(function () {
                                            ...
                                            $.ajax({
                                                ...
                                                url: remoteHost + "/get_table_by_id",
                                                contentType: "application/json;charset=UTF-8",
                                                success: function (result) {
                                                    var res = JSON.parse(result);
                                                    console.log(res);
...
>>>>>>> customize
                                ...
                                $('input.search').keypress(function (e) {
                                    if (e.which == 13) $('#confirm_button').click();
                                });
                                ...
                                $("#add_new_class_button").click(function () {
                                    while (true) {
                                        ...
                                        // 输入为空
                                        else if (new_class_name === "") alert("分类名不能为空!");
                                        else {
...
>>>>>>> customize
                                ...
                                $('#confirm_button').click(function () {
                                    ...
                                    if (save_status) $.ajax({
                                        ...
                                        url: remoteHost + "/delete_table_by_id",
                                        contentType: "application/json;charset=UTF-8",
                                        success: function (result) {
                                            var res = JSON.parse(result);
                                            console.log(res);
...
>>>>>>> customize
            ...
            if (!state.canCopy) $(".mCopy").addClass("disabled");
            else $(".mCopy").removeClass("disabled");

            if (!state.hasTables) $(".mFind").addClass("disabled");
            else $(".mFind").removeClass("disabled");
        }
                ...
                success: function (result) {
                    ...
                    $("#save_to_cloud").click(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                var to_send_data = {}
                                to_send_data['content'] = $(".table_content").html() changeTo(save_confirm_div);
                                var res = JSON.parse(result);
                                var prt = $("#all_class");
<<<<<<< HEAD
                                $.each(res, function(idx, ele) {
...
>>>>>>> customize
        ...
        $(".info_button").click(function () {
            ...
            $("#info_confirm_button").click(function (e) {
                ...
                if (($.trim(input_ava_url.val())).length > 0) info_dict['ava_url'] = input_ava_url.val();
                else info_dict['ava_url'] = set_obj_ava.attr("src");

                if (($.trim(set_obj_pn.val())).length > 0) info_dict['person_net'] = set_obj_pn.val();
                else info_dict['person_net'] = '无';

                if (($.trim(set_obj_intr.val())).length > 0) info_dict['intro'] = set_obj_intr.val();
                else info_dict['intro'] = '无';
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (res.status === 'success') {
                        ...
                        if (items.length == 0) {
                            if (cur_lang) prt.append('<h2 style="margin-left:20px; line-height:180px;">还没有人分享过表格呢，快来分享吧!</h2>')
                            else prt.append('<h2 style="margin-left:20px; line-height:180px;">No Table ... </h2>')
                        } else {
                            prt.empty();
<<<<<<< HEAD
                            $.each(items, function(idx, ele) {
                                ...
                                $.ajax({
                                    type: "post",
                                    data: '{"table_id":"' + table_v + '"}',
                                    url: remoteHost + "/get_table_name",
                                    contentType: "application/json;charset=UTF-8",
                                    success: function(result) {
                                        var res = JSON.parse(result);
                                        console.log(res);
                                ...
                                $.ajax({
                                    type: "get",
                                    url: remoteHost + "/get_avatar_url?username=" + username_v,
                                    success: function(result) {
                                        var res = JSON.parse(result);
                                        console.log(res);
                                        if (res.status === 'success') {
...
var updateLang = function(lang) {
        if (typeof(lang) !== "undefined") cur_lang = lang;
...
var makeTableEditable = function() {
        ...
        if (tbl) tbl[0].contentEditable = true;
    }
=======
    $(".table_content").html(tableContent);
}
