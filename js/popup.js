...
">
                <h3 class="ui teal header ">
                    <i class="warning circle icon "></i>     <div class="content "><span id = "plz_log_in_text ">请登录以便在云端同步您的表格数据!</span></div></h3>
            </div>
            ...
            <div class="currentTable ">
                <div class="table_content " id="scrollbar ">
                    <h3 class="prompt " style="color: #2185D0 " id="no_select_prompt ">
                        <i class="info big circle icon blue " id="no_select_head "></i>   <span id="no_table_selected_text ">当前未选中表格</span></h3>
                </div>
...
margin - left: 50px;
">注册</button>
            <button class="ui violet button " type="reset "><span id = "reset_text ">重置</span></button></form>
    </div>
    <!-- 注册页面 结束 -->
`,
...
margin - top: 25px;
"><span id="denglu_text ">登录</span></button></form>
    </div> 
    <!-- 登录页面 结束 -->
`;
...
">
          <div class="field " >
                <input type="text " name="avatar_url " placeholder="请输入个性化头像的url " id="avatar_url "></div>
          </div>
...
margin - left: 50px;
">确定</button>
            <button class="ui violet button " id="info_cancel_button ">取消</button></form>
        </div>
    </div>
...
<div id="share_square ">
        ...
        <div id="share_square_content_div ">
            <div class="ui feed share_feed_div " id="scrollbar "></div>
        </div>
</div>
`;
...
id = "" > <div class = "visible content " > <i class = "share alternate icon" > </i>&nbsp;<span id="share_text">分享... </span > &nbsp; < /div></button >
