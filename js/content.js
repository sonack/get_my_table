...
(function main() {
        ...
        var scrollWatch = function() {
                ...
                if (selection.scrollBase) { // 相对于滚动基点滚动
                        ...
                        var s = adjust(
                        selection.scrollBase.scrollLeft, selection.scrollBase.scrollTop, selection.scrollBase.clientWidth, selection.scrollBase.clientHeight, lastEvent.clientX - b[0], lastEvent.clientY - b[1]);
                        ...
                        var s = adjust(
                        window.scrollX, window.scrollY, window.innerWidth, window.innerHeight, lastEvent.clientX, lastEvent.clientY);
        ...
        var selectionUpdate = function(e) {
                ...
                var rect = [
                Math.min(cx, ax), Math.min(cy, ay), Math.max(cx, ax), Math.max(cy, ay)];
        ...
        var selectTable = function(table) {
                ...
                // 滚动到表格位置
                window.scrollTo(
                xy[0] - window.innerWidth / 3, xy[1] - window.innerHeight / 3);
        }
